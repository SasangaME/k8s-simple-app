# IAM role + ServiceAccount + Helm release for the AWS Load Balancer Controller.
# This is what makes the Ingress (kind: Ingress, ingressClassName: alb) provision an ALB.
